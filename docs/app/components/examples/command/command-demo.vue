...
import { Command, CommandEmpty, CommandGroup, CommandInput, CommandItem, CommandList, CommandSeparator, CommandShortcut } from 'moriui'
</script>
<template>
  <Command class="rounded-lg border shadow-md">
    ...
    <CommandList>
      ...
      <CommandGroup heading="设置">
        ...
        <CommandItem disabled>API<CommandShortcut>⌘A</CommandShortcut></CommandItem>
      </CommandGroup>
    </CommandList>
  </Command>
</template>
